...
namespace CollectionTracking.WinFormUI
{
    public partial class Form1 : Form
    {
        ...
        //Form yükleme anında yapılan işlemler
        ...
        // Datagrid'e tıklandığı anda gerçekleşen işlemler
        ...
        //Arama işlemi
        private void tbxFilmSearch_TextChanged(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(tbxFilmSearch.Text))
            {
                dgwFilm.DataSource = _filmService.GetFilmsByFilmName(tbxFilmSearch.Text);
            }
            else
            {
                LoadFilms();
